#!/bin/bash
# ====================================================================
# user-data.sh - Bootstrap do servidor Nginx via EC2 User Data
# Autor: Lucas Ribeiro Penhoela
# Uso: colar no campo User Data do launch. Roda como root no
# primeiro boot; saida completa em /var/log/cloud-init-output.log
# ====================================================================
